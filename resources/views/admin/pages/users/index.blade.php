                    ...
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($row->name)
                                        <a href="{{route('admin.user.detail', ['id' => $row->id])}}">
                                            <img src="{{ Avatar::create($row->name)->toBase64() }}" width='30' alt="">   
                                        </a>
                                    @endif
                                </td>
                                <td>
                                    <a href="{{route('admin.user.detail', ['id' => $row->id])}}">{{$row->name}}</a>
                                </td>
                                <td>{{$row->email}}</td>
                                <td>
                                    <input type="checkbox" id="switch{{$row->id}}" data-toggle="toggle" switch="success" checked />
